...
- [m11-native-go-sdk.md](milestones/m11-native-go-sdk.md) - M11 - Native Go SDK 层 - proposed
- [m12-jsonrpc-interface.md](milestones/m12-jsonrpc-interface.md) - M12 - JSON-RPC 接口 - proposed
- [m13-http-rest-api.md](milestones/m13-http-rest-api.md) - M13 - HTTP REST API - proposed
- [m14-grpc-interface.md](milestones/m14-grpc-interface.md) - M14 - gRPC 接口 - proposed
- [m15-auto-spec-driven-integration.md](milestones/m15-auto-spec-driven-integration.md) - M15 - auto-spec-driven 集成与收尾 - proposed
- [m16-background-process.md](milestones/m16-background-process.md) - M16 - 后台进程管理与 Server 类工具 - proposed
